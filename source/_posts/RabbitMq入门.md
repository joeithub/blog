...
![消费过程](/images/jinguo.png "消费过程")


多个消费者可以订阅同一个Queue，这时Queue中的消息会被平均分摊给多个消费者进行处理，而不是每个消费者都收到所有的消息并处理。

[![多消费者同时订阅一个队列](/images/多消费者同时订阅.png "多消费者同时订阅一个队列")](http://tong.com:8888/examples/ "多消费者同时订阅一个队列")
...
![prefetch](/images/prefetch.png "prefetch")

### 6、Exchange
在上一节我们看到生产者将消息投递到Queue中，实际上这在RabbitMQ中这种事情永远都不会发生。实际的情况是，生产者将消息发送到Exchange（交换器，下图中的X），由Exchange将消息路由到一个或多个Queue中（或者丢弃）。

![exchange](/images/exchange.png "exchange")
...
![binding](/images/binding.png "binding")
